...
name: example-skill
description: |
  Demonstrates the universal skill format with progressive disclosure.
...
2. For detailed explanation of the format: `references/format-guide.md`
3. To generate sample output: `scripts/generate.sh`
4. For advanced patterns: `references/advanced-patterns.md`

## Quick Reference

- Use ``references/name.md`` to reference detailed documentation
- Use ``scripts/name.sh`` to execute scripts
